...
class AVLTree():
    ...
    def insert_node(self, root: TreeNode, key) -> TreeNode:
    ...
    def delete_node(self, root: TreeNode, key) -> TreeNode:
    ...
    def printAVLtree(self, curRoot: TreeNode, indent, last) -> None:
        if curRoot != None:
            print(indent, end="")
            if last:
                print("R----", end="")
                ...
                indent += "|    "
            print(curRoot.key)
            self.printAVLtree(curRoot.left, indent, False)
            self.printAVLtree(curRoot.right, indent, True)
